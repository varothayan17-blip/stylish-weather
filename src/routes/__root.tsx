...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Wethra" },
      { name: "description", content: "Weather-powered clothing recommendations." },
      { name: "theme-color", content: "#3a8ff5" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "Wethra" },
      { property: "og:title", content: "Wethra" },
      { property: "og:description", content: "Weather-powered clothing recommendations." },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "/icon-512.png" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Wethra" },
      { name: "twitter:description", content: "Weather-powered clothing recommendations." },
