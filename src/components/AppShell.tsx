  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden isolate">
      ...
      >
        ...
        <div
          className={`${orb} top-1/3 -right-24 h-72 w-72 bg-accent/40`}
          style={{ animationDelay: "2s" }}
        />
        <div
          className={`${orb} bottom-0 left-1/4 h-72 w-72 bg-primary/20`}
          style={{ animationDelay: "4s" }}
        />
      </div>
      <main className="mx-auto max-w-md px-5 pb-36 pt-[calc(env(safe-area-inset-top)+1.5rem)]">
        {children}
      </main>
      <BottomNav />
    </div>
